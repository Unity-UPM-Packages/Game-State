# com.thelegends.gamestate.manager


A com.thelegends.gamestate.manager package for the [Unity](https://unity.com/) Game Engine.
...
- Add the `com.thelegends.gamestate.manager` package
